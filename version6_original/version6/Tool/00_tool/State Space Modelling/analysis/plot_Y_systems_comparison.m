function plot_Y_systems_comparison(abs_and_angle_1, abs_and_angle_2,max_freq)
    control = 1;
    ...
    hold off
    ylabel('$|Y_{pp}|$', 'Interpreter', 'Latex', 'FontSize', 12)
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * 1, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$|Y_{pn}|$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * -90, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$\theta_{Y_{pp}}$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * -90, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$\theta_{Y_{pn}}$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * 1, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$|Y_{np}|$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * 1, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$|Y_{nn}|$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * -90, 'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$\theta_{Y_{np}}$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    ...
    plot(karray1/(2*pi), ones(1, size(karray1, 2)) * -90,  'LineStyle', '--', 'Color', [0.8500, 0.3250, 0.0980])
    hold off
    ylabel('$\theta_{Y_{nn}}$', 'Interpreter', 'Latex', 'FontSize', 12)
    xlabel('f [Hz]', 'Interpreter', 'Latex', 'FontSize', 12)
    xlim([0,max_freq])
    
    % Create the legend on the first axes and place it outside the plot area
    lgd = legend([h1, h2], {'2 CIGs', '4 CIGs'}, ...
