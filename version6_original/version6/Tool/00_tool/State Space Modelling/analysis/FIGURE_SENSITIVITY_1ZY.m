function abs_and_angle=FIGURE_SENSITIVITY_1ZY(ss,factorArray)
    %ylimit=1.5;
    ...
    abs_and_angle=table();
    abs_and_angle.absnn=absnn;
    abs_and_angle.absnp=absnp;
    abs_and_angle.abspn=abspn;
    abs_and_angle.abspp=abspp;
    abs_and_angle.anglenn=anglenn;
    abs_and_angle.anglenp=anglenp;
    abs_and_angle.anglepn=anglepn;
    abs_and_angle.anglepp=anglepp;
    abs_and_angle.karray=karray';
