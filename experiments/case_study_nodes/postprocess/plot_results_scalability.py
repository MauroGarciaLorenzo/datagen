...
def plot_scaling(grouped, output_dir):
    ...
    plt.errorbar(nodes, speedup, yerr=errors_speedup, fmt='o-', label='Measured Speedup')
    ...
    plt.errorbar(nodes, times_hours, yerr=errors_hours, fmt='o-', label='Execution Time')
    plt.xlabel("Number of Nodes")
    ...
    # Efficiency Plot
    plt.figure(figsize=(6.4, 4.8))
    plt.errorbar(nodes, efficiency, yerr=errors_efficiency, fmt='o-', label='Measured Efficiency')
