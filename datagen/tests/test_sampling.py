...
class Test(TestCase):
    ...
    def test_sensitivity(self):
        ...
        dims_linear = sensitivity(linear_cases_df, dims, divs_per_cell)
        dims_linear_divs = [dim.divs for dim in dims_linear]
        dims_parab = sensitivity(parab_cases_df, dims, divs_per_cell)
        dims_parab_divs = [dim.divs for dim in dims_parab]
        dims_dim0 = sensitivity(dim0_cases_df, dims, divs_per_cell)
