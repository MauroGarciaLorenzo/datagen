...
params_pu
sim('VSC_GF_nonlinear_pu')
linear_model_pu
sim('VSC_GF_linear_4_pu')
...
% plot(tnolin,u_q_real_n1,'k','Color',valid_col(1,:),'linewidth',1.5)
hold all
plot(tnolin,u_q_real_n1_pu,'-.k','Color',valid_col(1,:),'linewidth',1.5)
plot(tlin,u_q_lineal4_n1_pu,'-.k','Color',valid_col(2,:),'linewidth',1.5)
...
% plot(tnolin,u_d_real_n1,'k','Color',valid_col(1,:),'linewidth',1.5)
hold all
plot(tnolin,u_d_real_n1_pu,'-.k','Color',valid_col(1,:),'linewidth',1.5)
plot(tlin,u_d_lineal4_n1_pu,'-.k','Color',valid_col(2,:),'linewidth',1.5)
...
% plot(tnolin,is_q_real_n1,'k','Color',valid_col(1,:),'linewidth',1.5)
hold all
plot(tnolin,is_q_real_n1_pu,'-.k','Color',valid_col(1,:),'linewidth',1.5)
plot(tlin,is_q_lineal4_n1_pu,'-.k','Color',valid_col(2,:),'linewidth',1.5)
...
% plot(tnolin,is_d_real_n1,'k','Color',valid_col(1,:),'linewidth',1.5)
hold all
plot(tnolin,is_d_real_n1_pu,'-.k','Color',valid_col(1,:),'linewidth',1.5)
plot(tlin,is_d_lineal4_n1_pu,'-.k','Color',valid_col(2,:),'linewidth',1.5)
...
plot(tlin,freq_lineal4_n1_pu,'-.k','Color',valid_col(2,:),'linewidth',1.5)
