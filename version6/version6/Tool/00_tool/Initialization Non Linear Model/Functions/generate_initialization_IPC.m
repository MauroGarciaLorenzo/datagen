function init_IPC = generate_initialization_IPC(T_IPC,T_global)
    ...
    for ipc = 1:1:height(T_IPC)
        ...
        Vg       = (T_IPC.V(ipc)/sqrt(3))/T_IPC.Vbpu_l2g(ipc); % PCC line-neutral voltage RMS 
        ...
        switch mode
            ...
            case 'AC-GFOL_DC-GFOL'
                ...
                initIPC.Udiff_mag   = Udiff_mag*T_IPC.Vbpu_l2g(ipc);
                ...
                Is_mag = sqrt(is_q0^2+is_d0^2)*T_IPC.Ibpu_l2g(ipc);
                ...
                % RL filter
                initIPC.Rc = T_IPC.Rc(ipc)*T_IPC.Zbpu_l2g(ipc);
                initIPC.Lc = T_IPC.Lc(ipc)*T_IPC.Zbpu_l2g(ipc);
                initIPC.Ra = T_IPC.Ra(ipc)*T_IPC.Zbpu_l2g(ipc);
                initIPC.La = T_IPC.La(ipc)*T_IPC.Zbpu_l2g(ipc); 
                ...
                initIPC.isum0_DC = T_IPC.Pdc(ipc)/(3*T_IPC.Vdc(ipc));
