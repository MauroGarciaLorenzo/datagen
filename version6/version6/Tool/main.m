...
% Case name as in Excel files
    caseName ='/TestDyn_2CIGs/OP_7'; %'test_MPC'; 
...
% Display and select all global input & outputs
    %run display_io.m  
    input = {'NET.Rld1'};
    output = {'GFOL1.w','GFOR2.w','Load1.id','Load1.iq','NET.id_1_2','NET.iq_1_2','NET.vn1d',...
                'NET.vn1q','NET.vn2d','NET.vn2q','TH1.id','TH1.iq','VSC1.id','VSC1.iq','VSC2.id','VSC2.iq'};
