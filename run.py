...
def run():
    ...
    dimensions = [Dimension(p_sg, n_cases, 2, 0,
                            5, "p_sg"),
                  Dimension(p_cig, n_cases, 1, 0,
                            6, "p_cig"),
                  Dimension(tau_f_g_for, n_cases, 1, 0,
                            2, "tau_f_g_for"),
                  Dimension(tau_v_g_for, n_cases, 1, 0,
                            2, "tau_v_g_for"),
                  Dimension(tau_p_g_for, n_cases, 1, 0,
                            2, "tau_p_g_for"),
                  Dimension(tau_q_g_for, n_cases, 1, 0,
                            2, "tau_q_g_for")]
    ax = None
